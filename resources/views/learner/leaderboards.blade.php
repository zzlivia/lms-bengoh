    ...
    <div class="container mt-4">
        ...
        @endif
                    <div class="text-center mb-4">
                        <div class="progress-title">{{ __('messages.courses.leaderboards') }}</div>
                    </div>
                    <div class="card leaderboard-card p-4">
                        <h5 class="text-center mb-4">{{ __('messages.courses.leaderboard_subtitle') }}</h5>
                        <table class="table text-center">
                            <thead>
                                <tr>
                                    <th>{{ __('messages.courses.rank') }}</th>
                                    <th>{{ __('messages.courses.name') }}</th>
                                    <th>{{ __('messages.courses.completed_courses') }}</th>
                                    <th>{{ __('messages.courses.badge_earned') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php $rank = 1; @endphp
