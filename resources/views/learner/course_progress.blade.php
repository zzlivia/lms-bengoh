        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <!-- left side -->
                    <div class="col-md-8">
                        <h5 class="fw-bold">{{ __('messages.courses.your_progress') }}</h5>
                ...
                @endif
                <!-- grades -->
                <h5 class="fw-bold mb-3">{{ __('messages.courses.your_grades') }}</h5>
                <div class="card shadow-sm">
                    <div class="card-body p-0">
                        <table class="table mb-0 text-center">
                            <thead class="table-light">
                                <tr>
                                    <th>{{ __('messages.courses.task') }}</th>
                            ...
                            <tbody>
                                ...
                                @endforeach
                                <tr class="fw-bold">
                                    <td>{{ __('messages.courses.total_grade') }}</td>
                                    <td></td>
